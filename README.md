...
-Delivery: It generates an executable that, when opened, extracts and displays the decoy file to the user while silently 
initiating the connection to the C2 server in the background.
